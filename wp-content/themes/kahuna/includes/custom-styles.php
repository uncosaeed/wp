...
a#toTop 										{ color: <?php echo esc_html( $kahuna_accent1 ) ?>;
											  border-color: <?php echo esc_html( $kahuna_accent1 ) ?>; }
a#toTop:hover								{ background-color: <?php echo esc_html( $kahuna_accent1 ) ?>;
...
.kahuna-stripped-table .main tr:nth-child(odd) td,
.kahuna-stripped-table .main tr:nth-child(odd) th
...
body.mce-content-body, .wp-block {	
	...
	font-family: <?php echo cryout_font_select( $kahuna_fgeneral, $kahuna_fgeneralgoogle ) ?>;
	font-size: <?php echo esc_html( $kahuna_fgeneralsize ) ?>;
	line-height: <?php echo esc_html( (float) $kahuna_lineheight ) ?>;
...
%%scope%% p { text-indent: <?php echo esc_html( $kahuna_parindent ) ?>; }
